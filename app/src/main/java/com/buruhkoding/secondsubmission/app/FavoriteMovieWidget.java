...
public class FavoriteMovieWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.buruhkoing.secondsubmission.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.buruhkoding.secondsubmission.EXTRA_ITEM";
